    ...
    public whyIrresistibles: Array<any> = [
        {
            ...
            description: '5 de cada 10 personas están bastante preocupados por su condición física y salud. Nuestros productos responden de manera efectiva a la necesidad del consumidor actual.'
        },
        {
            ...
            description: 'El poder de la naturaleza está en cada uno de nuestros productos. Con el proceso único de trazabilidad garantizamos que los ingredientes sean puros, seguros y efectivos.'
        },
        {
